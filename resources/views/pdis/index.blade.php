        ...
        <tbody>
            @foreach ($pdis as $pdi)
                <tr>
                    ...
                    <td>@if(isset($pdi->finalizacao))Finalizado @else Em andamento @endif</td>
                    <td>{{ $pdi->created_at->isoFormat('D [de] MMMM [de] YYYY') ?? $pdi->created_at->isoFormat('D [de] MMMM [de] YYYY') }}</td>
                    <td>
                        ...
                        @empty($pdi->finalizacao->resumo_avaliacao_trimestral_aluno)
