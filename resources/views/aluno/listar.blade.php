            ...
            <div class="col-md-12">
              <div style="width: 100%; margin-left: 0%;" class="row">
                ...
                <div style="float:right" class="col-md-3">
                  <a style="float:right; margin-top:20px; background-color: #0398fc; color: white; font-weight: bold; font-size: 15px; padding: 7px; border-radius: 5px; border-color: #0398fc; box-shadow: 4px 4px 4px #CCC" href="{{ route('aluno.buscar')}}" >
                ...
                foreach ($alunos as $aluno) {?>
                  <div class="col-md-3 mt-3">
                    <a href="{{ route('aluno.gerenciar', ['id_aluno'=>$aluno->id]) }}#perfil" style="display: block;">
                      <div style="padding: 15px; margin: 10px; border-radius: 20px; max-height: 270px; box-shadow: 4px 4px 4px 4px #CCC;" id="teste">
