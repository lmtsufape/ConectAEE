...
@section('content')
        ...
        @foreach ($alunos as $aluno)
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-danger" data-toggle="modal" data-target="#modalConfirm" onclick="setDadosModal('{{ route('alunos.delete' , ['aluno_id' => $aluno->id]) }}','{{$aluno->nome}}')" >
  ...
  @include('alunos.filter-modal', compact('gres', 'municipios', 'escolas'))
  <!--Modal Confirm-->
