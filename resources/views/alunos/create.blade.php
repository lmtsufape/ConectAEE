    ...
    <form class="m-3" method="POST" action="{{ route('alunos.store') }}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input value="{{old('matricula')}}" type="text" class="form-control @error('matricula') is-invalid @enderror" id="matricula" name="matricula" required>
                @error('matricula')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
            ...
            <div class="form-group col-md-3">
                ...
                <input value="{{old('cpf')}}" type="text" class="form-control @error('cpf') is-invalid @enderror" id="cpf" name="cpf" required>
                @error('cpf')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
        ...
        <div class="row mb-3">
            ...
            <div class="form-group col-md-4">
                ...
                <input value="{{old('idade_inicio_estudos')}}" type="number" min="0" class="form-control @error('idade_inicio_estudos') is-invalid @enderror" id="idade_inicio_estudos" name="idade_inicio_estudos" required>
            ...
            <div class="form-group col-md-4">
                ...
                <input value="{{old('idade_escola_atual')}}" type="number" min="0" class="form-control @error('idade_escola_atual') is-invalid @enderror" id="idade_escola_atual" name="idade_escola_atual" required>
        ...
        <div class="row mb-3">
            ...
            <div class="form-group col-md-4">
                ...
                <input value="{{old('descricao_cid')}}" type="text" class="form-control @error('descricao_cid') is-invalid @enderror" id="descricao_cid" name="descricao_cid" required>
                @error('descricao_cid')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
        ...
        <div class="row mb-3">
            ...
            <div class="form-group col-md-2">
                ...
                <input value="{{old('numero')}}" type="text" class="form-control @error('numero') is-invalid @enderror" id="numero" name="numero" required>
                @error('numero')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
            ...
            <div class="form-group col-md-3">
                ...
                <input value="{{old('bairro')}}" type="text" class="form-control @error('bairro') is-invalid @enderror" id="bairro" name="bairro" required>
                @error('bairro')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
            ...
            <div class="form-group col-md-2">
                ...
                <input value="{{old('cep')}}" type="text" class="form-control @error('cep') is-invalid @enderror" id="cep" name="cep" required>
                @error('cep')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control @error('escolaridade_pai') is-invalid @enderror" name="escolaridade_pai" id="escolaridade_pai" required>
                        ...
                        @foreach ($escolaridadeAdulto as $escolaridade)
                            <option value="{{$escolaridade}}" @selected(old('escolaridade_pai') == $escolaridade)>{{$escolaridade}}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control @error('escolaridade_mae') is-invalid @enderror" name="escolaridade_mae" id="escolaridade_mae" required>
                        ...
                        @foreach ($escolaridadeAdulto as $escolaridade)
                            <option value="{{$escolaridade}}" @selected(old('escolaridade_mae') == $escolaridade)>{{$escolaridade}}</option>
                        @endforeach
                    </select>
        ...
        <div class="row mb-3">
            <div class="form-group col-md-2">
                ...
                <input value="{{old('num_irmaos')}}" type="number" min="0" class="form-control @error('num_irmaos') is-invalid @enderror" id="num_irmaos" name="num_irmaos" required>
                @error('num_irmaos')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
            ...
            <div class="form-group col-md-5">
                ...
                <input value="{{old('mora_com')}}" type="text" class="form-control @error('mora_com') is-invalid @enderror" id="mora_com" name="mora_com" required>
                @error('mora_com')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{$message}}</strong>
                    </span>
            ...
            <div class="form-group col-md-5">
                ...
                <input value="{{old('contato_responsavel')}}" type="text" class="form-control @error('contato_responsavel') is-invalid @enderror" id="contato_responsavel" name="contato_responsavel" required>
        ...
        <div class="form-group  mb-3">
            ...
            <select class="form-control @error('escolaridade_atual_aluno') is-invalid @enderror" name="escolaridade_atual_aluno" id="escolaridade_atual_aluno" required>
                ...
                @foreach ($escolaridadeAluno as $escolaridade)
                    <option value="{{$escolaridade}}" @selected(old('escolaridade_atual_aluno') == $escolaridade)>{{$escolaridade}}</option>
