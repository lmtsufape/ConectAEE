                ...
                <div class="panel panel-default" style="padding: 10px 20px;" id="login-card">
                    ...
                    <div class="panel-body panel-body-cadastro">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <form method="POST" action="{{ route("objetivo.criar") }}">
                                ...
                                <input id="id_aluno" type="hidden" class="form-control" name="id_aluno"
                                       value="{{ $aluno->id }}">

                                <div class="form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                                    <label for="titulo" class="col-md-12 control-label">Título <font
                    ...
                    <strong>{{ $errors->first('titulo') }}</strong>
                                ...
                                <div class="form-group{{ $errors->has('descricao') ? ' has-error' : '' }}">
                                    <label for="descricao" class="col-md-12 control-label">Descrição <font
                                                color="red">*</font> </label>

                                    <div class="col-md-12">
                                        <textarea id="descricao" rows="8" cols="50" class="form-control"
                      ...
                      <strong>{{ $errors->first('descricao') }}</strong>
                                ...
                                <div class="form-group{{ $errors->has('tipo') ? ' has-error' : '' }}">
                                    <label for="tipo" class="col-md-12 control-label">Tipo <font
                                                color="red">*</font></label>
                      ...
                      <strong>{{ $errors->first('tipo') }}</strong>
                                ...
                                <div class="form-group{{ $errors->has('prioridade') ? ' has-error' : '' }}">
                                    <label for="prioridade" class="col-md-12 control-label">Prioridade <font
                                                color="red">*</font></label>
